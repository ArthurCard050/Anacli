...
export default function BlogMainGrid({ posts }: BlogMainGridProps) {
  const mainPosts = posts.slice(3, 9);
  const listPosts = posts.slice(9);
          ...
          <div className="space-y-8">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl font-bold text-gray-900">Mais Lidos</h2>
              </div>
