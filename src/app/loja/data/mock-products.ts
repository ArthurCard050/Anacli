...
export const mockPackages: ExamPackage[] = [
  {
    ...
    exams: ['hemograma-completo', 'ferritina', 'glicemia-jejum', 'hba1c', 'colesterol-total', 'hdl', 'ldl', 'triglicerideos', 'ureia-creatinina', 'tgo-tgp', 'sodio', 'potassio', 'acido-urico', 'tsh', 'urina-tipo-i'],
    price: 97.00,
  ...
  },
  {
    ...
    exams: ['hemograma-completo', 'ferritina', 'glicemia-jejum', 'hba1c', 'colesterol-total', 'hdl', 'ldl', 'triglicerideos', 'ureia-creatinina', 'tgo-tgp', 'bilirrubinas', 'sodio', 'potassio', 'calcio', 'tsh', 'urina-tipo-i'],
    price: 117.00,
