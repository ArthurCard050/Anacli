...
import { Eye, EyeOff, User, Phone, Calendar } from 'lucide-react';
...
export const SignUpPage: React.FC<SignUpPageProps> = ({
  ...
  description = "Junte-se a nós e comece sua jornada de cuidados com a saúde",
  heroImageSrc,
  testimonials = [],
  onSignUp,
  onSignIn,
  ...
  return (
    <div className="sign-up-page h-screen w-screen flex flex-col md:flex-row font-sans overflow-hidden">
      {/* Left column: sign-up form */}
      <section className="flex-1 flex items-center justify-center p-4 md:p-8 min-h-0">
        <div className="w-full max-w-md max-h-full">
          <div className="flex flex-col gap-3 md:gap-4 py-2 md:py-4 max-h-screen overflow-y-auto">
            {/* Logo da Anacli */}
      ...
      {heroImageSrc && (
        <section className="hidden md:block flex-1 relative p-4 min-h-0">
          <div 
            className="animate-slide-right animate-delay-300 absolute inset-4 rounded-3xl bg-cover bg-center bg-no-repeat min-h-[400px]" 
